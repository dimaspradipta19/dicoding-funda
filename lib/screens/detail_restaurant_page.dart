        ...
        body: Consumer<DetailRestaurantProvider>(
          builder: (context, DetailRestaurantProvider detailRestaurant, _) {
            if (detailRestaurant.state == ResultState.loading) {
                      ...
                      Stack(
                        children: [
                          ClipRRect(
                            ...
                            child: Image.network(
                                "https://restaurant-api.dicoding.dev/images/medium/${detailRestaurant.detailRestaurant.restaurant.pictureId}"),
                            // child: FlutterLogo(
                            //   size: 200,
                            // ),
                          ),
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              ...
                              detailRestaurant.detailRestaurant.restaurant.name,
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  detailRestaurant.detailRestaurant.restaurant.city,
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  // "Restaurant rating",
                                  detailRestaurant.detailRestaurant.restaurant.rating
                                      .toString(),
                                  style: myTextTheme.bodyLarge!
                            ...
                            Text(
                              ...
                              detailRestaurant.detailRestaurant.restaurant.description,
              ...
              return Center(
                child: Text(detailRestaurant.message),
              );
